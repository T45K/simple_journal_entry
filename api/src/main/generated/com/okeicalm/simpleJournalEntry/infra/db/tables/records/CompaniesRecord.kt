...
open class CompaniesRecord() : UpdatableRecordImpl<CompaniesRecord>(Companies.COMPANIES), Record2<Long?, String?> {
    ...
    override fun field2(): Field<String?> = Companies.COMPANIES.NAME
    ...
    override fun value2(value: String?): CompaniesRecord {
        this.name = value
        return this
    }

    override fun values(value1: Long?, value2: String?): CompaniesRecord {
        this.value1(value1)
        this.value2(value2)
        return this
    }
