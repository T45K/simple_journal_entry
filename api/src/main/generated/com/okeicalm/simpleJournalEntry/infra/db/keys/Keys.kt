...
val KEY_COMPANIES_PRIMARY: UniqueKey<CompaniesRecord> = Internal.createUniqueKey(Companies.COMPANIES, DSL.name("KEY_companies_PRIMARY"), arrayOf(Companies.COMPANIES.ID), true)
